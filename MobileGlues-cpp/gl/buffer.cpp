...
void glBufferData(GLenum target, GLsizeiptr size, const void* data, GLenum usage) {
    // VinzzRenderer: Remap usage hints for Adreno 650
    extern int g_is_adreno_650;
    if (g_is_adreno_650 && usage == GL_STREAM_DRAW) {
        usage = GL_DYNAMIC_DRAW; // Adreno 650 driver handles DYNAMIC better than STREAM
    }
    LOG()
